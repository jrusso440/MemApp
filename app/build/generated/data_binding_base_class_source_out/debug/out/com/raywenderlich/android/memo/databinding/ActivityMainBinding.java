...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button btnPauseMusic = ViewBindings.findChildViewById(rootView, id);
      ...
      Button btnPlayMusic = ViewBindings.findChildViewById(rootView, id);
      ...
      Button btnShuffleMusic = ViewBindings.findChildViewById(rootView, id);
      if (btnShuffleMusic == null) {
        break missingId;
      }

      id = R.id.btnSongName;
      Button btnSongName = ViewBindings.findChildViewById(rootView, id);
      if (btnSongName == null) {
        break missingId;
      }

      id = R.id.btnStopMusic;
      Button btnStopMusic = ViewBindings.findChildViewById(rootView, id);
      ...
      ConstraintLayout musicOptions = ViewBindings.findChildViewById(rootView, id);
